...
def get_dataset(dataset_name):
    if dataset_name=="Heart Attack":
        data=pd.read_csv("C:/Users/ACER/Downloads/MLheart/anbu project/Data/heart.csv")
        st.header("Heart Attack Prediction")
        return data

    else:
        data=pd.read_csv("C:/Users/ACER/Downloads/MLheart/anbu project/Data/BreastCancer.csv")
...
def plot_op(dataset_name):
    ...
    if dataset_name == "Heart Attack":
        col1.write(Y)
        sns.countplot(x=Y, palette='gist_heat', hue=Y, legend=False)
...
def get_classifier(clf_name,params):
    ...
    if clf_name == "Logistic Regression":
        ...
        clf = DecisionTreeClassifier(max_depth=params["M"],criterion=params["C"],min_impurity_decrease=params["SS"])
